        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                LazyVGrid(columns: columns, spacing: 20) {
                    ForEach(0..<viewModel.currentPageCount, id: \.self) { index in
        ...
        VStack(spacing: 8) {
            ZStack(alignment: .topLeading) {
                if let page = viewModel.document.page(at: index) {
                    let stPage = STDOCXPage(id: index, page: page)
                    Image(platformImage: stPage.thumbnail(maxSize: 200))
                        .resizable()
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 4) {
                    ...
                    toolbarButton(
                        ...
                        enabled: viewModel.hasSelection && viewModel.selectedPages.count < viewModel.currentPageCount
                    ) {
