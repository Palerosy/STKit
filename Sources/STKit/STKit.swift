...
/// STKitSDK — Unified Document SDK for iOS
/// Supports DOCX, Excel, TXT and more document formats.
///
/// ```swift
/// // Initialize with license key
/// STKitSDK.initialize(licenseKey: "eyJidW5kbGVJZCI6Li4u...")
///
/// // Use STDOCX module
/// import STDOCX
